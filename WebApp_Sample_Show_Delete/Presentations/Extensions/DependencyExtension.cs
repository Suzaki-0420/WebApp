...
using WebApp_Sample_Show_Delete.Applications.Services;
using WebApp_Sample_Show_Delete.Applications.Services.Impls;
using WebApp_Sample_Show_Delete.Infrastructures.Adapters;
using WebApp_Sample_Show_Delete.Infrastructures.Context;
using WebApp_Sample_Show_Delete.Infrastructures.Repositories;
using WebApp_Sample_Show_Delete.Presentations.Controllers;
using WebApp_Sample_Show_Delete.Presentations.ViewModels;
namespace WebApp_Sample_Show_Delete.Presentations.Extensions;
/// <summary>
/// 依存定義および依存性注入クラス
/// </summary>
